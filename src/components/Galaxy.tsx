...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    // Performance optimization: limit dpr to 1.0 for better performance on background visuals
    ...
    const update = (t: number) => {
      ...
      if (!disableAnimation) {
        const timeValue = t * 0.001;
        program.uniforms.uTime.value = timeValue;
        program.uniforms.uStarSpeed.value = (timeValue * starSpeed) / 10.0;
      }
    ...
    // Passive resize to avoid scroll jank
  ...
  return <div ref={ctnDom} className="galaxy-container" style={{ transform: 'translate3d(0,0,0)', contain: 'strict' }} {...rest} />;
}
